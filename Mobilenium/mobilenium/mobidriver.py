...
from browsermob_proxy_py.browsermobproxy import Server
...
class Firefox(webdriver.Firefox):
    def __init__(self, browsermob_binary=None, firefox_binary=None,
                 ...
                 firefox_options=None, upstream_proxy={}, existing_proxy_port_to_use=None):

        self.browsermob_binary = browsermob_binary
        self.blacklist = {}
        params = {}
        if isinstance(upstream_proxy, dict):
            params = upstream_proxy
        if existing_proxy_port_to_use:
            params['existing_proxy_port_to_use'] = existing_proxy_port_to_use
        self.set_browsermob_proxy(params)
    ...
    def set_browsermob_proxy(self, params):
        self.server = Server(self.browsermob_binary)
        self.server.start()
        self.proxy = self.server.create_proxy(params=params)
    ...
    def quit_driver(self):
        ...
        '''
        super(webdriver.Firefox, self).quit()
